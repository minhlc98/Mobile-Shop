...
public class ThanhToan extends AppCompatActivity {
    ...
    public void Mapping() {
        edt[0] = findViewById(R.id.edtTen);
        edt[1] = findViewById(R.id.edtDT);
        edt[2] = findViewById(R.id.edtDiaChi);
        edt[3] = findViewById(R.id.edtEmail);
        btnXacNhan = findViewById(R.id.btnXacNhan);
        btnHuy = findViewById(R.id.btnHuy);
        list_countryCode = findViewById(R.id.list_countryCode);
    ...
    public boolean check_valid_info() {
        ...
        validation[1] = "\\d{9,12}$";    //Điện thoại
